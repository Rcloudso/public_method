...
class BaseCouponList(KeyWeb):
    ...
    def choose_coupon_type(self):
        ...
        # coupon_type_lists = self.get_ele_list(value="//ul[@role='listbox']", value1="li")
        # for coupon_type in coupon_type_lists:
        #     print(coupon_type.text)
